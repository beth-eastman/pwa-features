...
var ExternalLink = (function (_super) {
    ...
    function ExternalLink() {
        ...
        _this.handleExternalNavigation = function (event) {
            event.preventDefault();
            event.stopPropagation();
            var _a = _this.props, absolutePath = _a.absolutePath, target = _a.target;
    ...
    ExternalLink.prototype.render = function () {
        return React.createElement("span", { onTouchTap: this.handleExternalNavigation }, this.props.children);
    };
